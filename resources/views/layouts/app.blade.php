        ...
        <div class="flex items-center justify-between h-16 px-4">
            ...
            <div class="flex-1 max-w-2xl mx-auto flex items-center px-4">
                <div class="relative flex-1">
                    <div class="relative">
                        <input type="text" placeholder="Video veya içerik ara..."
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if (!sidebar) return; // sidebar yoksa devam etme
        ...
        // Resize: lg ve üstünde sidebar her zaman açık
        const handleResize = () => {
            if (window.innerWidth >= 1024) {
                ...
                // mobilde, başlangıçta kapalı olsun
                if (!sidebar.classList.contains('-translate-x-full') && !overlay) {
                    // eğer overlay yok ve sidebar açıksa kapat (sayfa yenilenmesinde açık kalıyorsa)
                    sidebar.classList.add('-translate-x-full');
                    sidebar.classList.remove('translate-x-0');
                }
            }
        ...
        if (userMenuButton && userMenu) {
            userMenuButton.addEventListener('click', (e) => {
                e.stopPropagation(); // dış tıklama kapanmasın
