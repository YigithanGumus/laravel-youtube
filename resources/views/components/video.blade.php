<div @mouseenter="speechText('{{$video->title}}')" class="group bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow">
	{{-- Thumbnail --}}
